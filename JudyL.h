...
#define JL_LEAF1GROWINPLACE(Pop1) \
        J__U_GROWCK(Pop1, cJL_LEAF1_MAXPOP1, jL_Leaf1PopToWords)
#define JL_LEAF2GROWINPLACE(Pop1) \
        J__U_GROWCK(Pop1, cJL_LEAF2_MAXPOP1, jL_Leaf2PopToWords)
#define JL_LEAF3GROWINPLACE(Pop1) \
        J__U_GROWCK(Pop1, cJL_LEAF3_MAXPOP1, jL_Leaf3PopToWords)
#define JL_LEAFWGROWINPLACE(Pop1) \
        J__U_GROWCK(Pop1, cJL_LEAFW_MAXPOP1, jL_LeafWPopToWords)
#define JL_LEAFVGROWINPLACE(Pop1)  \
        J__U_GROWCK(Pop1, cJL_BITSPERSUBEXPL,  jL_LeafVPopToWords)
...
Pjbb_t judyLAllocJBB(Pjpm_t);	// constant size.
Pjp_t judyLAllocJBBJP(Word_t, Pjpm_t);
Pjbu_t judyLAllocJBU(Pjpm_t);	// constant size.
Pjll_t judyLAllocJLL1(Word_t, Pjpm_t);
Pjll_t judyLAllocJLL2(Word_t, Pjpm_t);
Pjll_t judyLAllocJLL3(Word_t, Pjpm_t);
Pjlw_t judyLAllocJLW(Word_t);	// no Pjpm_t needed.
Pjlb_t judyLAllocJLB1(Pjpm_t);	// constant size.
Pjv_t judyLAllocJV(Word_t, Pjpm_t);
Pjpm_t judyLAllocJPM(void);

void judyLFreeJPM(Pjpm_t PjpmFree, Pjpm_t PjpmStats);
void judyLFreeJLPM(Pjpm_t, Pjpm_t);	// constant size.
void judyLFreeJBL(Pjbl_t, Pjpm_t);	// constant size.
void judyLFreeJBB(Pjbb_t, Pjpm_t);	// constant size.
void judyLFreeJBBJP(Pjp_t, Word_t, Pjpm_t);
void judyLFreeJBU(Pjbu_t, Pjpm_t);	// constant size.
...
void judyLFreeJLB1(Pjlb_t, Pjpm_t);	// constant size.
